...
class SettingController extends BackEndController {
	...
	public function getSettingForm( $setting )
	{
		...
		{
			case 'textarea':
			echo CHtml::textArea( $name, $value, array( 'rows' => 5, 'class' => 'textbox form-control', 'disabled' => $setting->disabled ? 'disabled' : '' ) );
			break;
			
			case 'image':
			echo CHtml::fileField( $name, $value, array( 'class' => 'textbox form-control', 'disabled' => $setting->disabled ? 'disabled' : '' ) );
			break;
			
			case 'dropdown':
			echo CHtml::dropDownList( $name, $value, $this->convertExtraToArray( $setting->extra ), array( 'class' => 'select form-control', 'disabled' => $setting->disabled ? 'disabled' : '' ) );
			break;
			
			case 'multi':
			echo CHtml::listBox( $name, $value ? explode(',', $value) : '', $this->convertExtraToArray( $setting->extra ), array('size' => 20,  'multiple' => 'multiple', 'class' => 'chosen form-control', 'disabled' => $setting->disabled ? 'disabled' : '' ) );
			break;
			
			case 'checkbox':
			echo CHtml::checkbox( $name, $setting->value != '' ? $setting->value : $setting->default_value, array( 'class' => 'form-control', 'disabled' => $setting->disabled ? 'disabled' : '' ) );
			break;
			
			case 'yesno':
			echo CHtml::dropDownList( $name, $value, array( '0' => Yii::t('global', 'No'), '1' => Yii::t('global', 'Yes') ), array( 'class' => 'select form-control', 'disabled' => $setting->disabled ? 'disabled' : '' ) );
			break;
			...
			case 'text':
			default:
			echo CHtml::textField( $name, $value, array( 'class' => 'textbox form-control', 'disabled' => $setting->disabled ? 'disabled' : '' ) );
			break;
		}
	}
