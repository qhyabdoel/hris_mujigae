			...
			<div class="panel-body">
				<?php $this->widget('CGridView', array(
					...
					'columns' => array(
						...
						array('name'=>'employee_id', 'header'=>at('Employee'), 'value'=>'$data->employee->getFullname()', 'htmlOptions' => array( 'style' => 'width:150px;')),
						array('name'=>'type_id', 'header'=>at('Type'), 'value'=>'$data->viewType()', 'htmlOptions' => array( 'style' => 'width:100px;')),
