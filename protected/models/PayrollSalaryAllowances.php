...
/**
 * This is the model class for table "payroll_salary_allowances".
 *
 * The followings are the available columns in table 'payroll_salary_allowances':
 * @property integer $id
 ...
 * @property PayrollSalary $salary
 */
class PayrollSalaryAllowances extends CActiveRecord
{
	/**
	...
	{
		return 'payroll_salary_allowances';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'salary' => array(self::BELONGS_TO, 'PayrollSalary', 'salary_id'),
		);
	}
	 ...
	 * @return PayrollSalaryAllowances the static model class
	 */
