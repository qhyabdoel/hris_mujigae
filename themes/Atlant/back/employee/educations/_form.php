		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						<?php echo CHtml::activeDropDownList($model, 'address_state_id', CHtml::listData(ReferenceGeoStates::model()->byCountry($model->address_country_id)->byOrder()->findAll(), 'id', 'name')
										, array(
											'data-placeholder' => at('Please select one...'),
											'prompt' => '',
											'data-live-search' => 'true',
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						<?php echo CHtml::activeDropDownList($model, 'address_city_id', CHtml::listData(ReferenceGeoCities::model()->byState($model->address_state_id)->byOrder()->findAll(), 'id', 'name'), array('data-placeholder' => at('Please select one...'), 'prompt' => '', 'data-live-search' => 'true', 'class' => 'validate[required] form-control select')); ?>
