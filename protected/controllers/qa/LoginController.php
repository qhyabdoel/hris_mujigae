...
class LoginController extends BackEndController
{
	...
	public function actionIndex() {
    	...
    	if(isset($_POST['QaLogin'])) {
    		$form->setAttributes($_POST['QaLogin']);
    		...
    		if($form->validate()) {    			    			
				...
				AdminLoginHistory::model()->addLog($_POST['QaLogin']['nik'], $_POST['QaLogin']['password'], 1);
				...
				// Add to login history
				AdminLoginHistory::model()->addLog($_POST['QaLogin']['nik'], $_POST['QaLogin']['password'], 0);
    		}
