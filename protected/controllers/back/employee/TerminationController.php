...
class TerminationController extends BackEndController
{
	...
	{
		$model=new EmployeeTermination('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['EmployeeTermination']))
			$model->attributes=$_GET['EmployeeTermination'];
	 ...
	 * @param EmployeeTermination $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='employee-termination-form')
		{
