...
<body>
	...
	<p>
		...
		selaku <?php echo $actor->rolename; ?> tidak menyetujui permintaan mutasi yang dibuat oleh anda. 
	...
	<p>
		Anda dapat memperbaiki persetujuan untuk mutasi selaku <?php echo $target->rolename; ?> 
