<?php 
$title = 'View Mutation';
if($model->type=='rotation') $title = 'View Rotation';
?>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<ul class="panel-controls">
						...
						<?php if ($model->status=='draft' and $model->created_by=='admin') {
							?><li><?php echo CHtml::link(at('Update'), createUrl('employees/mutation_update',array('id'=>$model->id)), array('class'=>'btn btn-primary')); ?></li><?php
						} ?>
						...
						?>
							<li>
								...
								if(getUser()->role==$model->approver_level){
									echo CHtml::link(at('Approve'), createUrl('employees/mutation_approve', array(
							...
							<li>
								...
								if(getUser()->role==$model->approver_level){
									if($model->type=='rotation'){
										echo CHtml::link(at('Reject'), createUrl('employees/mutation_cancel', array(
