  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      var actionsbox = this.options.actionsBox ? '<div class="bs-actionsbox">' +
          ...
          '</div>' +
          '</div>' : '';
	  var newbutton = '<div><button type="button" class="btn btnselectnew" aria-hidden="true" onclick="javascript: vPopup()">Create New</button></div>';
      var drop =
...
function updateDropdown(parent, obj, data)
{
	obj.empty();
	obj.append(data);
