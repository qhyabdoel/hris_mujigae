...
<div class="row">
    <div class="col-md-12">
		<div class="panel panel-default">
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">                                                                                                                                           
						<div class="input-group">
							<?php echo CHtml::textField('employee_name', $employee->fullname, array('size'=>100,'readonly'=>true,'class' => 'validate[required] form-control disabled')); ?>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						<div class="form-inline">
							...
							&nbsp; <span id="long_leave_info">{ Current Leaves : 2 / 3 ( Max : 1 ) } { Total Leaves : 21 } </span>
						</div>
			...
			<input value="save" name="action" id="action" hidden>
...
<?php if(getUser()->role <> 'employee' && getUser()->role <> '') { ?>
