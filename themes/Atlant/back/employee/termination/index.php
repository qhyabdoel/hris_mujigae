...
<div class="page-title">                    
	<h2><span class="fa fa-crop"></span> <?php echo at('Employee Termination'); ?></h2>
</div>
<!-- END PAGE TITLE -->
			...
			<div class="panel-body">
				<?php $this->widget('DTGridView', array(
					...
					'columns'=>array(
						...
						array('name'=>'terminate_type', 'header'=>at('Type')),
						array('name'=>'terminate_date', 'header'=>at('Terminate Date')),
						array('name'=>'comments', 'header'=>at('Comments')),
