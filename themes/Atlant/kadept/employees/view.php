...
<script>
	...
	// 		$.post('<?php echo Yii::app()->createUrl("employees/ajaxgetdata "); ?>',
	// 		 {
	// 		 	id : id, employee_id : employee_id, action : action
	// 		 },
	// 		 function(data) {
	// 		 	$('#modelModalBody').html(data);
	// 		 	$('#MastersEmployees_gender').selectpicker();
	// 		 	$('#MastersEmployees_religion_id').selectpicker();
	// 		 	$('#MastersEmployees_ethnic').selectpicker();
	// 		 	$('#MastersEmployees_married_status').selectpicker();
	// 		 	$('#MastersEmployees_status').selectpicker();
	// 		 	$('#MastersEmployees_is_active').selectpicker();
	// 		 	$('#MastersEmployees_identity_type_id').selectpicker();
	// 		 	$('#MastersEmployees_birthplace_country_id').selectpicker();
	// 		 	$('#MastersEmployees_birthplace_state_id').selectpicker();
	// 		 	$('#MastersEmployees_birthplace_city_id').selectpicker();
	// 		 	$('#MastersEmployees_birthplace_district_id').selectpicker();
	// 		 	$('#MastersEmployees_department_id').selectpicker();
	// 		 	$('#MastersEmployees_section_id').selectpicker();
	// 		 	$('#MastersEmployees_position_id').selectpicker();
	// 		 	$('#MastersEmployees_level_id').selectpicker();
	// 		 	$('#MastersEmployees_grade_id').selectpicker();
	// 		 	$('#modelModal').modal();
	// 		 });
