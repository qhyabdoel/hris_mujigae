			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						<?php echo CHtml::activeTextField($model, 'short', array('size'=>50,'maxlength'=>50,'class' => 'validate[required] form-control')); ?>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						<?php echo CHtml::activeTextField($model, 'level', array('class' => 'validate[required] form-control')); ?>
