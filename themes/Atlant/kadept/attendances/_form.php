				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						<div class="input-group bootstrap-timepicker">
							...
							<?php 
							echo CHtml::activeTextField($model, 'break_out', array('class' => 'validate[required] form-control timepicker24')); 
							?>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						<div class="input-group bootstrap-timepicker">
							...
							<?php 
							echo CHtml::activeTextField($model, 'break_in', array('class' => 'validate[required] form-control timepicker24')); 
							?>
...
$('#check_break_out').change(function (argument) {
	alert($('#check_break_out').is(':checked'));
	// $('#check_break_in').attr('checked');
});
