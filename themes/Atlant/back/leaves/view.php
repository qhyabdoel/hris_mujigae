			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<ul class="panel-controls">
						...
						<?php if($model->status == 'draft' && is_null($model->approval_by_rm) && (is_null($model->approval_by_bm) || is_null($model->approval_by_hr))) { ?>
						...
						<li><?php echo CHtml::link(at('Approve'), createUrl('leaves/approve', array('id'=>$model->id, 's'=>1)), array('class'=>'btn btn-default')); ?></li>
						<li><?php echo CHtml::link(at('Rejected'), createUrl('leaves/approve', array('id'=>$model->id, 's'=>0)), array('class'=>'btn btn-default')); ?></li>
						<?php } ?>											
					</ul>
				</div>
