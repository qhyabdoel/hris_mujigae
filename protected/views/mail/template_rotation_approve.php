...
<body>
	...
	<p>
		...
		selaku <?php echo $actor->rolename; ?> telah menyetujui permintaan rotasi 
		yang dibuat oleh <?php echo $creator_name; ?> selaku <?php echo $creator_role; ?>.
	...
	<p>
		Anda dapat melihat data rotasi ini dengan mengunjungi aplikasi HRIS Mujigae melalui link di bawah ini.
	</p>
