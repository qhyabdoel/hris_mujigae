...
class EmployeesController extends BackEndController
{
	...
	public function actionTes(){
		// $employee = MastersEmployees::model()->findByPk(2);

		// echo "<pre>";
		// print_r($employee->PayrollEmployeeAllowances->values);
		// echo "</pre>";

		echo getUser()->employee->rolename;
	}
	...
	public function actionMutation($id)
	{
		...
		if(!isset($model)) $this->redirect(array('mutation_view','id'=>0));
	...
	public function actionMutation_view($id)
	{
		...
		$this->render('mutation_view', array('model'=>$model));	
	}
