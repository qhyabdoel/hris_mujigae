			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">                                                                                                                                           
						<div class="input-group">
							...
							<?php 
								echo CHtml::activeHiddenField($model, 'employee_id', array('class' => 'validate[required] form-control')); 
							?>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						...
						echo CHtml::activeDropDownList($model, 'country_id', $datas
										, array(
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						<?php echo CHtml::activeDropDownList($model, 'state_id', CHtml::listData(ReferenceGeoStates::model()->byCountry($model->country_id)->byOrder()->findAll(), 'id', 'name')
										, array(
											'data-placeholder' 	=> at('Please select one...'),
											'prompt' 			=> '',
											'data-live-search' 	=> 'true',
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						<?php echo CHtml::activeDropDownList($model, 'city_id', CHtml::listData(ReferenceGeoCities::model()->byState($model->state_id)->byOrder()->findAll(), 'id', 'name')
										, array(
											'data-placeholder' 	=> at('Please select one...'),
											'prompt' 			=> '',
											'data-live-search' 	=> 'true',
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						<?php echo CHtml::activeDropDownList($model, 'district_id', CHtml::listData(ReferenceGeoDistricts::model()->byCity($model->city_id)->byOrder()->findAll(), 'id', 'name'), array('data-placeholder' => at('Please select one...'), 'prompt' => '', 'data-live-search' => 'true', 'class' => 'validate[required] form-control select')); ?>
