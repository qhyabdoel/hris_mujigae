...
<div class="page-title">                    
	<h2><span class="fa fa-group"></span> <?php echo at('Berita Acara'); ?></h2>
</div>
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">                                
				<?php echo CHtml::link(at('Create'), array('beritaacara'), array('class'=>'btn btn-default')); ?>
				...
				$this->widget('CGridView', array(
					...
					'columns' => array(
						...
						array(
							...
							'buttons' => array(								
								'view' => array(								
									'url' => 'createUrl("attendances/beritaacara_view", array("id"=>"$data->id"))',
								),
							),
						),
					),
