...
<div class="page-title">                    
	<h2><span class="fa fa-group"></span> <?php echo at('Attendances'); ?></h2>
</div>
<!-- END PAGE TITLE -->
    ...
    <div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">                                
				...
				<?php echo CHtml::link(at('Import'), array('import'), array('class'=>'btn btn-primary')); ?>
				<?php /*echo CHtml::link(at('Generate Recapitulation'), array('generate'), array('class'=>'btn btn-info'));*/ ?>
