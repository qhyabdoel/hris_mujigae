...
<tr>
	<td>
		...
		<tbody>
			...
			<tr><th><?php echo at('Total In'); ?></th><td><?php echo $recap->total_in; ?></td></tr>
			...
			<tr><th><?php echo at('Total Alpha') ?></th><td><?php echo $recap->total_alpha; ?></td></tr>
	...
	<td>
		...
		<table class="table">
		<tbody>
			<tr><th><?php echo at('Basic Salary') ?></th><td><?php echo $model->basic_salary; ?></td></tr>
			<?php $salaryallowances = $model->payrollSalaryAllowances; ?>
			<?php foreach($salaryallowances as $salaryallowance) { ?>
				<tr><th><?php echo $salaryallowance->allowance->name; ?></th><td><?php echo $salaryallowance->values; ?></td></tr>
			<?php } ?>
		</tbody>
		</table>
	</td>
...
<tfoot>
	...
	<tbody>
		<tr><td colspan="2" width="50%"><span class="terbilang"><?php echo Terbilang::write($model->total_salary); ?></span></td>
			...
			<td><?php echo $model->total_salary; ?></td>
		</tr>
	</tbody>
	</table>
</tfoot>
