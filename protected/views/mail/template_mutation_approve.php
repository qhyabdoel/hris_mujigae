...
<?php 
	...
	if($creator_name==$target->fullname) $creator_name == 'anda';
?>
...
<body>
	...
	<p>
		...
		selaku <?php echo $actor->rolename; ?> telah menyetujui permintaan mutasi yang dibuat oleh <?php echo $creator_name; ?> selaku <?php echo $creator_role; ?>. 
		Berikut data mutasi yang dibuat:
	</p>		
	...
	<p>
		Anda dapat melihat data mutasi dengan mengunjungi aplikasi HRIS Mujigae melalui link di bawah ini.
	</p>
