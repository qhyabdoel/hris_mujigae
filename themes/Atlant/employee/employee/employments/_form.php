    ...
    <div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<?php echo CHtml::activeHiddenField($model, 'employee_id', array('size'=>60,'maxlength'=>255,'class' => 'validate[required] form-control')); ?>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-xs-12">
						<div class="input-group">
							...
							<?php echo CHtml::activeTextField($model, 'work_date', array('class' => 'validate[required] form-control datepicker')); ?>
						</div>
