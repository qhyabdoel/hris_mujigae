			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<ul class="panel-controls">
						<li><?php echo CHtml::link(at('Edit'), createUrl('employees/update', array('id'=>$model->id)), array('class'=>'btn btn-primary')); ?></li>
					</ul>
				</div>
	...
	<div class="col-md-12">
		...
		$this->widget('zii.widgets.jui.CJuiTabs',array(
			'tabs'=>array(
				...
				at('Salary')=>array('content'=>$this->renderPartial('view/salary', array('model'=>$model, 'isform'=>false), true)),
			),
			'options'=>array(
				'collapsible'=>false,
			),
