...
<div class="page-title">                    
	<h2><span class="fa fa-crop"></span> <?php echo at('Medical Check Up'); ?></h2>
</div>
<!-- END PAGE TITLE -->
			...
			<div class="panel-body">
				<?php $this->widget('DTGridView', array(
					...
					'columns'=>array(
						...
						array('name'=>'mcu_date', 'header'=>at('Checkup Date')),
						array('name'=>'mcu_place', 'header'=>at('Checkup Place')),
						array('name'=>'mcu_status', 'header'=>at('Status')),
