...
class LoginController extends BackEndController
{
	...
	public function actionIndex() {
    	$form = new KadeptLogin;

    	if(isset($_POST['KadeptLogin'])) {
    		$form->setAttributes($_POST['KadeptLogin']);
    		...
    		if($form->validate()) {
				...
				AdminLoginHistory::model()->addLog($_POST['KadeptLogin']['nik'], $_POST['KadeptLogin']['password'], 1);
				...
				if(strpos($returnUrl, yiiparam('kadeptUrl').'?r=login') !== false) {
					$returnUrl = array('/');
				}
				...
				// Add to login history
				AdminLoginHistory::model()->addLog($_POST['KadeptLogin']['nik'], $_POST['KadeptLogin']['password'], 0);
    		}
